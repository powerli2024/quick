...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--policy-json", type=Path, default=None, help="frozen route policy JSON; defaults to configs/route_policy.json")
    ...
    p.add_argument("--qkw-switch-margin", type=float, default=None)
    p.add_argument("--nll-switch-margin", type=float, default=None)
    p.add_argument("--speaker-switch-margin", type=float, default=None)
    p.add_argument("--cer-close-delta", type=float, default=None)
    p.add_argument("--noise-switch-margin", type=float, default=None)
    p.add_argument("--snr-switch-margin-db", type=float, default=None)
    p.add_argument("--dnsmos-switch-margin", type=float, default=None)
    p.add_argument("--prefer-se-on-close-cer", action=argparse.BooleanOptionalAction, default=None)
    ...
    p.add_argument("--cer-mean-max", type=float, default=None)
    p.add_argument("--cer0-drop-max", type=float, default=None)
